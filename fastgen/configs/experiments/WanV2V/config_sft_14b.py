...
from fastgen.configs.net import VACE_Wan_14B_Config, CKPT_ROOT_DIR
from fastgen.utils import LazyCall as L
from fastgen.methods import SFTModel

"""Configs for SFT on VACE-WAN 14B model."""
...
def create_config():
    ...
    config.model.net = VACE_Wan_14B_Config
    ...
    config.log_config.group = "vacewan_14b_sft"
    return config
